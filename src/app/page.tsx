        ...
        <section className="container mx-auto px-4 py-24 text-center">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
              An obsessive travel analytics dashboard. Log trips, visualize
              your journey on an interactive map, and explore every metric of
              your travel life.
            </p>
        ...
        <section className="border-t bg-muted/40 py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              Create your account and start logging trips today. No
              subscription, no ads.
            </p>
            <Link href="/sign-up">
              <Button size="lg" className="gap-2">
