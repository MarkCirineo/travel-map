...
const TravelMap = dynamic(() => import("@/components/map/travel-map").then((m) => m.TravelMap), {
    ssr: false,
    loading: () => (
...
export default function MapPage() {
    ...
    return (
        <div className="relative h-[calc(100vh-8rem)] -m-4 lg:-m-6">
            <TravelMap visitedData={visitedData} onFeatureClick={setSelectedInfo} />
            <MapTooltip info={selectedInfo} onClose={() => setSelectedInfo(null)} />
        </div>
    );
}
